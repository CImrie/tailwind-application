<template>
      <div class="max-w-full mt-48 relative">
        <WallOfText :rows="15" :columns="20" :me-position="11">
        ...
        <div class="lg:block absolute ml-16 lg:ml-[695px] -mt-24 lg:-mt-40 xl:-mt-[260px] transition-all ease-in-out duration-200">
          <div class="flex flex-col items-center">
            <img alt="Connor Forsyth with his son on his shoulders" src="~/assets/images/connor.png" class="h-60 lg:h-52 xl:h-[336px]"/>
            <div class="flex flex-col items-center">
